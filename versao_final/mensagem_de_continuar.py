...
class MensagemDeContinuar(MensagemDePilhaDeEstados):
    """
    Esta mensagem contém a instrução de continuar no estado atual e
    não alterar a pilha de estados do programa.
    """
    def __init__(self):
        self.__numero_de_estados_para_remover = 0
        self.__estados_para_adicionar = []
        self.__esvaziar_pilha_de_estados = False
